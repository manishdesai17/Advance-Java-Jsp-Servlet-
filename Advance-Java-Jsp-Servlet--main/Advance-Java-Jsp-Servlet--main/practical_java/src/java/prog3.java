...
public class prog3 extends HttpServlet {
     ...
     */
    public void display(String msg,PrintWriter out,HttpServletRequest request, HttpServletResponse response)
    {
         try {
...
//            out.println("document.getElementById('months').value='" + month + "';");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String msg="";
            int success=0;
            if(fname.equalsIgnoreCase("") || lname.equalsIgnoreCase("") || password.equalsIgnoreCase("") ||confpassword.equalsIgnoreCase("")|| email.equalsIgnoreCase("")||address.equalsIgnoreCase("")||mobile.equalsIgnoreCase("")|| role.equalsIgnoreCase(""))
            {
                System.out.println("In if");
                msg="Please fill all reqired filed.";
            }
            if(success!=1)
            {
                System.out.println("call function");
                display(msg,out,request,response);
            }
        }
    }
